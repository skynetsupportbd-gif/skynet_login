...
//
// এই ফাংশন login.html থেকে ভাউচার-কোড নিয়ে cnMaestro-র
// EasyPass "Third-Party Integration" Login API-তে সিকিউরভাবে POST করে।
// Secret key কখনো client-side এ যায় না — শুধু এই সার্ভারলেস ফাংশনের ভেতরে থাকে।
...
exports.handler = async (event) => {
  ...
  if (!ga_ap_mac || !ga_cmac || !ga_Qv || !ga_user || !ga_pass) {
    return {
      statusCode: 422,
  ...
  try {
    const response = await fetch(
      `${BASE_URL}/api/v1/easypass/external-portal/login`,
      {
        method: "POST",
        headers: {
